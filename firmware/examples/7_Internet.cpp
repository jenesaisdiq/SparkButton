...
found here: http://docs.spark.io/firmware/#spark-function

The code to control the number of illuminated LEDs is here:
https://github.com/jenesaisdiq/SparkButton/blob/master/controlKnob.html
Try naming one of your devices "SparkButton" and running controlKnob in your browser or on your phone!
Note that the Core or Photon *must* be named "SparkButton" because the javascript looks for it.
*/ 
